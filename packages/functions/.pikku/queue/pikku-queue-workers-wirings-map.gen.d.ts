...
import type { ShippingAddress } from '/private/tmp/claude-501/-Users-yasser-git-pikku/826f30f1-670b-4be2-be0c-b0ea1529b795/scratchpad/tpl/packages/functions/src/wirings/checkout.workflow.ts'
import type { AIMessage, AgentRunRow, AIThread } from '/private/tmp/claude-501/-Users-yasser-git-pikku/826f30f1-670b-4be2-be0c-b0ea1529b795/scratchpad/tpl/node_modules/@pikku/core/dist/wirings/ai-agent/ai-agent.types.d.ts'
...
export type QueueMap = {
  ...
  readonly 'audit-event': QueueHandler<WriteAuditEventInput, null>,
  readonly 'process-export': QueueHandler<ProcessExportInput, null>,
  readonly 'wf-orchestrator-checkout-workflow': QueueHandler<null, null>,
  readonly 'wf-orchestrator-refund-workflow': QueueHandler<null, null>,
};
