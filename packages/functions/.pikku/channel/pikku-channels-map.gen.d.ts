...
import type { AIThread, AIMessage, AgentRunRow } from '@pikku/core/dist/wirings/ai-agent/ai-agent.types'
import type { ShippingAddress } from '../../src/wirings/checkout.workflow.js'

import type { AIThread, AIMessage, AgentRunRow } from '/private/tmp/claude-501/-Users-yasser-git-pikku/826f30f1-670b-4be2-be0c-b0ea1529b795/scratchpad/tpl/node_modules/@pikku/core/dist/wirings/ai-agent/ai-agent.types.d.ts'
...
export type ChannelsMap = {
  readonly 'order-status': {
    readonly routes: {
      readonly type: {
        readonly subscribe: ChannelHandler<SubscribeToOrderInput, never>,
        readonly unsubscribe: ChannelHandler<UnsubscribeFromOrderInput, never>,
      },
    },
